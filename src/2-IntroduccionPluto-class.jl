...
# ╔═╡ 2f00e352-3a84-428b-911d-52a363f37cc6
a = 5

# ╔═╡ 748e04aa-6ac9-4378-9923-a5e5d42bf170
b = collect(0:10)

# ╔═╡ 5a75fe00-5b2b-46e3-93f9-a922f04aba3c
c = a .+ b
...
# ╔═╡ dd9861ed-494f-46a4-98da-809a86fc446e
let
	a = 0
	f = 2
	e = 2+a+f
...
# ╔═╡ b10bdf61-66df-4498-ac7d-03fcf682769e
a
...
@bind sliderA Slider(0.0:0.1:1.0, 0.5, true)

# ╔═╡ 381bd976-99f8-49a5-97b0-f4ad980fcc09
@bind sliderChar Slider(["hector", "benjas", "cadi"], "cadi", true)

# ╔═╡ fe528f92-1264-4d9b-8274-f9e2b7488ab8
md"""
La operacion resulta en $(sliderA+10)
"""
...
md"""
B $(@bind sliderB Slider(0.0:0.1:1.0, 0.5, true))

C $(@bind sliderC Slider(0.0:0.1:1.0, 0.5, true))
"""

# ╔═╡ a014a66a-9381-4217-b746-b9ca5cfbae77
sliderB*sliderC
...
@bind scrubD Scrubbable(-10:10, default=1)

# ╔═╡ e348b212-c797-4e35-87db-edc48902cd46
sliderB+scrubD
...
@bind numberE NumberField(-5:5, default=-1)

# ╔═╡ 0fe622d0-b3ce-4c75-aad0-05ad43e6f7ba
(sliderB+scrubD)*numberE
...
@bind textoF TextField()

# ╔═╡ 5d8b760e-fbbc-47ce-9c17-8f958c96565e
md"""
El texto es $(textoF)
"""

# ╔═╡ 336ea415-c5fc-4a66-bc04-5a70bd4f23bb
typeof(textoF)

# ╔═╡ ed360bad-54d7-4903-91e1-6491ddec6866
numeroF = parse(Float64, textoF)

# ╔═╡ 2a127be2-695f-41b5-b09b-24902a6a6968
typeof(numeroF)

# ╔═╡ 63155ae4-e187-4d0c-813e-7eee6a696e2b
(sliderB+scrubD)*numberE + numeroF
...
md"""
Palomeando ando $(@bind checkG CheckBox())

Palomeando no ando $(@bind checkH CheckBox())
"""

# ╔═╡ 7181da6d-77b2-492a-84ed-87fc158ad01f
checkG, checkH

# ╔═╡ 481f7913-132c-47d8-8695-c79e47e34c89
md"""
El valor es $(checkG)
"""
...
@bind buttonH Button("Boton")

# ╔═╡ 3e6cd39d-0565-449e-a1d9-0ddb84f1ee90
buttonH

# ╔═╡ 04e76e72-416f-431b-b950-8beea1cac498
begin
	buttonH
	rand()
end
...
# ╔═╡ 12fa9168-e41a-4b40-8eac-53b9aa70b829
t

# ╔═╡ 75a039d7-fec2-456d-8091-da4a93503e19
deltaT = 1/60

# ╔═╡ b99e92f5-1fdb-46a3-9464-47d881b7e4bf
@bind tf Clock(deltaT, true)

# ╔═╡ 68e6f74c-2be7-4259-ad28-6f0885b5c4d5
tf
...
# ╔═╡ 491c52f2-2807-4605-a235-6b4e22f80fd0
 f(0; A=2)

# ╔═╡ b4df39fa-66c4-43eb-bb46-57c804d7f5f5
f(0; w=2)

# ╔═╡ 20261ab7-74a2-4ed7-924a-4ce9fd12b1ee
begin
	xs = collect(-5.0:0.01:5.0)
	plot(xs, f.(xs))
end

# ╔═╡ d1feaa6b-552e-44ba-b4b0-03344851ba6e
md"""
``x_0`` $(@bind x0 Slider(-1.0:0.01:1.0, 0.0, true))

``A`` $(@bind A0 Slider(0.0:0.01:1.0, 0.5, true))

``w`` $(@bind w0 Slider(0.0:0.01:1.0, 0.5, true))
"""

# ╔═╡ b1cb0ee6-6367-48c9-8308-b17da07880af
begin
	ys = f.(xs .- x0; A=A0, w=w0)
	plot(xs, ys, xlims=(-5,5), ylims=(0,1))
end
...
TableOfContents(title="Contenidos", indent=true, depth=3, aside=true)
